...
#define SWIG_init    boot_KBTreeUtil

#define SWIG_name   "KBTreeUtilc::boot_KBTreeUtil"
#define SWIG_prefix "KBTreeUtilc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_KBTreeUtil_var::
class _wrap_KBTreeUtil_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_KBTreeLib__KBTree = {"_p_KBTreeLib__KBTree", "KBTreeLib::KBTree *", 0, 0, (void*)"KBTreeUtil::KBTree", 0};
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_KBTreeLib__KBTree, (void*) "KBTreeUtil::KBTree");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
