...
public class KBaseTreesServer extends JsonServerServlet {
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_tree", async=true)
    public String getTree(String treeId, Map<String,String> options, RpcContext jsonRpcContext) throws Exception {
        String returnVal = null;
        //BEGIN get_tree
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_alignment", async=true)
    public String getAlignment(String alignmentId, Map<String,String> options, RpcContext jsonRpcContext) throws Exception {
        String returnVal = null;
        //BEGIN get_alignment
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_tree_data", async=true)
    public Map<String,TreeMetaData> getTreeData(List<String> treeIds, RpcContext jsonRpcContext) throws Exception {
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_alignment_data", async=true)
    public Map<String,AlignmentMetaData> getAlignmentData(List<String> alignmentIds, RpcContext jsonRpcContext) throws Exception {
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_tree_ids_by_feature", async=true)
    public List<String> getTreeIdsByFeature(List<String> featureIds, RpcContext jsonRpcContext) throws Exception {
        List<String> returnVal = null;
     ...
     * @return   instance of list of original type "kbase_id" (A KBase ID is a string starting with the characters "kb|".  KBase IDs are typed. The types are designated using a short string. For instance," g" denotes a genome, "tree" denotes a Tree, and "aln" denotes a sequence alignment. KBase IDs may be hierarchical.  For example, if a KBase genome identifier is "kb|g.1234", a protein encoding gene within that genome may be represented as "kb|g.1234.peg.771". @id kb)
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_tree_ids_by_protein_sequence", async=true)
    public List<String> getTreeIdsByProteinSequence(List<String> proteinSequenceIds, RpcContext jsonRpcContext) throws Exception {
        List<String> returnVal = null;
     ...
     * @return   instance of list of original type "kbase_id" (A KBase ID is a string starting with the characters "kb|".  KBase IDs are typed. The types are designated using a short string. For instance," g" denotes a genome, "tree" denotes a Tree, and "aln" denotes a sequence alignment. KBase IDs may be hierarchical.  For example, if a KBase genome identifier is "kb|g.1234", a protein encoding gene within that genome may be represented as "kb|g.1234.peg.771". @id kb)
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_alignment_ids_by_feature", async=true)
    public List<String> getAlignmentIdsByFeature(List<String> featureIds, RpcContext jsonRpcContext) throws Exception {
        List<String> returnVal = null;
     ...
     * @return   instance of list of original type "kbase_id" (A KBase ID is a string starting with the characters "kb|".  KBase IDs are typed. The types are designated using a short string. For instance," g" denotes a genome, "tree" denotes a Tree, and "aln" denotes a sequence alignment. KBase IDs may be hierarchical.  For example, if a KBase genome identifier is "kb|g.1234", a protein encoding gene within that genome may be represented as "kb|g.1234.peg.771". @id kb)
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_alignment_ids_by_protein_sequence", async=true)
    public List<String> getAlignmentIdsByProteinSequence(List<String> proteinSequenceIds, RpcContext jsonRpcContext) throws Exception {
        List<String> returnVal = null;
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_tree_ids_by_source_id_pattern", async=true)
    public List<List<String>> getTreeIdsBySourceIdPattern(String pattern, RpcContext jsonRpcContext) throws Exception {
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_leaf_to_protein_map", async=true)
    public Map<String,String> getLeafToProteinMap(String treeId, RpcContext jsonRpcContext) throws Exception {
     ...
     * @return   instance of mapping from original type "kbase_id" (A KBase ID is a string starting with the characters "kb|".  KBase IDs are typed. The types are designated using a short string. For instance," g" denotes a genome, "tree" denotes a Tree, and "aln" denotes a sequence alignment. KBase IDs may be hierarchical.  For example, if a KBase genome identifier is "kb|g.1234", a protein encoding gene within that genome may be represented as "kb|g.1234.peg.771". @id kb) to original type "kbase_id" (A KBase ID is a string starting with the characters "kb|".  KBase IDs are typed. The types are designated using a short string. For instance," g" denotes a genome, "tree" denotes a Tree, and "aln" denotes a sequence alignment. KBase IDs may be hierarchical.  For example, if a KBase genome identifier is "kb|g.1234", a protein encoding gene within that genome may be represented as "kb|g.1234.peg.771". @id kb)
     */
    @JsonServerMethod(rpc = "KBaseTrees.get_leaf_to_feature_map", async=true)
    public Map<String,String> getLeafToFeatureMap(String treeId, RpcContext jsonRpcContext) throws Exception {
        Map<String,String> returnVal = null;
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.import_tree_from_cds", async=true)
    public List<Tuple11<Long, String, String, String, Long, String, Long, String, String, Long, Map<String,String>>> importTreeFromCds(List<CdsImportTreeParameters> selection, String targetWsNameOrId, AuthToken authPart, RpcContext jsonRpcContext) throws Exception {
        ...
        CdsUtil cds = new CdsUtil(new URL(""));
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.compute_abundance_profile", async=true)
    public AbundanceResult computeAbundanceProfile(AbundanceParams abundanceParams, RpcContext jsonRpcContext) throws Exception {
     ...
     */
    @JsonServerMethod(rpc = "KBaseTrees.filter_abundance_profile", async=true)
    public Map<String,Map<String,Double>> filterAbundanceProfile(Map<String,Map<String,Double>> abundanceData, FilterParams filterParams, RpcContext jsonRpcContext) throws Exception {
