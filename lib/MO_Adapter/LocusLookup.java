...
public class LocusLookup {
	
	private RandomAccessFile db;
	
	/**
	 * Expects a long text file in the format:
	 * MO_LOCUS_ID MD5 SEQ_LENGTH
	 * @param locusFilename
	 */
	public LocusLookup(String locusFilename) throws IOException {
		db = new RandomAccessFile(locusFilename,"r");
	}
	...
	public void reload(String locusFilename) throws IOException {
		db.close();
		db = new RandomAccessFile(locusFilename,"r");
	}
