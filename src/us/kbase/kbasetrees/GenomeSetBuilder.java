...
public class GenomeSetBuilder {
	...
	public static void main(String[] args) throws Exception {
		String token = "...";
		String treeRef = "nardevuser1:home/tree.1";
		String genomeSetRef = "nardevuser1:home/genomeset.1";
		GenomeSetBuilder.buildGenomeSetFromTree("https://kbase.us/services/ws", token, treeRef, genomeSetRef);
	}
}
