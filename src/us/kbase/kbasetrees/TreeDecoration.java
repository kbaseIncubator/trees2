...
public class TreeDecoration {
    ...
    private Map<String, List<us.kbase.common.service.Tuple2 <String, String>>> treeValListString;
    @JsonProperty("tree_val_list_int")
    private Map<String, List<us.kbase.common.service.Tuple2 <Long, String>>> treeValListInt;
    @JsonProperty("tree_val_list_float")
    private Map<String, List<us.kbase.common.service.Tuple2 <Double, String>>> treeValListFloat;
    @JsonProperty("collapsed_by_node")
    private Map<String, String> collapsedByNode;
    @JsonProperty("substructure_by_node")
    private Map<String, us.kbase.common.service.Tuple2 <String, String>> substructureByNode;
    ...
    @JsonProperty("tree_val_list_string")
    public Map<String, List<us.kbase.common.service.Tuple2 <String, String>>> getTreeValListString() {
        return treeValListString;
    }

    @JsonProperty("tree_val_list_string")
    public void setTreeValListString(Map<String, List<us.kbase.common.service.Tuple2 <String, String>>> treeValListString) {
        this.treeValListString = treeValListString;
    }

    public TreeDecoration withTreeValListString(Map<String, List<us.kbase.common.service.Tuple2 <String, String>>> treeValListString) {
        this.treeValListString = treeValListString;
        return this;
    }

    @JsonProperty("tree_val_list_int")
    public Map<String, List<us.kbase.common.service.Tuple2 <Long, String>>> getTreeValListInt() {
        return treeValListInt;
    }

    @JsonProperty("tree_val_list_int")
    public void setTreeValListInt(Map<String, List<us.kbase.common.service.Tuple2 <Long, String>>> treeValListInt) {
        this.treeValListInt = treeValListInt;
    }

    public TreeDecoration withTreeValListInt(Map<String, List<us.kbase.common.service.Tuple2 <Long, String>>> treeValListInt) {
        this.treeValListInt = treeValListInt;
        return this;
    }

    @JsonProperty("tree_val_list_float")
    public Map<String, List<us.kbase.common.service.Tuple2 <Double, String>>> getTreeValListFloat() {
        return treeValListFloat;
    }

    @JsonProperty("tree_val_list_float")
    public void setTreeValListFloat(Map<String, List<us.kbase.common.service.Tuple2 <Double, String>>> treeValListFloat) {
        this.treeValListFloat = treeValListFloat;
    }

    public TreeDecoration withTreeValListFloat(Map<String, List<us.kbase.common.service.Tuple2 <Double, String>>> treeValListFloat) {
        this.treeValListFloat = treeValListFloat;
        return this;
    }
    ...
    @JsonProperty("substructure_by_node")
    public Map<String, us.kbase.common.service.Tuple2 <String, String>> getSubstructureByNode() {
        return substructureByNode;
    }

    @JsonProperty("substructure_by_node")
    public void setSubstructureByNode(Map<String, us.kbase.common.service.Tuple2 <String, String>> substructureByNode) {
        this.substructureByNode = substructureByNode;
    }

    public TreeDecoration withSubstructureByNode(Map<String, us.kbase.common.service.Tuple2 <String, String>> substructureByNode) {
        this.substructureByNode = substructureByNode;
        return this;
    }
