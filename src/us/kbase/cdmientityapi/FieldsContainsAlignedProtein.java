...
/**
 * <p>Original spec-file type: fields_ContainsAlignedProtein</p>
 * 
 * 
 */
...
public class FieldsContainsAlignedProtein {
    ...
    public FieldsContainsAlignedProtein withFromLink(String fromLink) {
        this.fromLink = fromLink;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withToLink(String toLink) {
        this.toLink = toLink;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withIndexInConcatenation(Long indexInConcatenation) {
        this.indexInConcatenation = indexInConcatenation;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withBegPosInParent(Long begPosInParent) {
        this.begPosInParent = begPosInParent;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withEndPosInParent(Long endPosInParent) {
        this.endPosInParent = endPosInParent;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withParentSeqLen(Long parentSeqLen) {
        this.parentSeqLen = parentSeqLen;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withBegPosAln(Long begPosAln) {
        this.begPosAln = begPosAln;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withEndPosAln(Long endPosAln) {
        this.endPosAln = endPosAln;
        return this;
    }
    ...
    public FieldsContainsAlignedProtein withKbFeatureId(String kbFeatureId) {
        this.kbFeatureId = kbFeatureId;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((((((("FieldsContainsAlignedProtein"+" [fromLink=")+ fromLink)+", toLink=")+ toLink)+", indexInConcatenation=")+ indexInConcatenation)+", begPosInParent=")+ begPosInParent)+", endPosInParent=")+ endPosInParent)+", parentSeqLen=")+ parentSeqLen)+", begPosAln=")+ begPosAln)+", endPosAln=")+ endPosAln)+", kbFeatureId=")+ kbFeatureId)+", additionalProperties=")+ additionalProperties)+"]");
    }
