...
deploy-services:
	...
	echo "exec $(KB_RUNTIME)/bin/starman --listen :$(PORT) --pid $(PID_FILE) " >> ./start_service
	echo "--daemonize --access-log $(ACCESS_LOG_FILE) " >>./start_service
	echo "--error-log $(ERROR_LOG_FILE) $(SERVICE_DIR)/lib/Trees.psgi" >> ./start_service
